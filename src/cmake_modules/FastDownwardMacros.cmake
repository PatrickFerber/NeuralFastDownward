...
function(fast_downward_plugin)
    ...
    set(_MULTI_VALUE_ARGS SOURCES DEPENDS PACKAGES)
    ...
    set(PLUGIN_${_PLUGIN_NAME}_PACKAGES ${_PLUGIN_PACKAGES} PARENT_SCOPE)
    list(APPEND PLUGINS ${_PLUGIN_NAME})
    set(PLUGINS ${PLUGINS} PARENT_SCOPE)
endfunction()

function(fast_downward_add_plugin_sources_and_packages _SOURCES_LIST_VAR _PACKAGES_LIST_VAR)
    ...
    list(REMOVE_DUPLICATES _PACKAGES_LIST_VAR)
    set(${_PACKAGES_LIST_VAR} ${${_PACKAGES_LIST_VAR}} PARENT_SCOPE)
